...
class MessageCounter(telepot.aio.helper.ChatHandler):
    ...
    async def on_close(self, msg):
        await self.sender.sendMessage('Refreshing count')


TOKEN = '779485434:AAExvneL3PdlbWCXDhgY-MiKLlJUI8gqST0'  # get token from command-line
